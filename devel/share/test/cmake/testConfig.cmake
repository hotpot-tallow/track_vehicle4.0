...
if("TRUE" STREQUAL "TRUE")
  set(test_SOURCE_PREFIX /home/cwkj/workspace/track_vehicle4.0/src/test)
  set(test_DEVEL_PREFIX /home/cwkj/workspace/track_vehicle4.0/devel)
  set(test_INSTALL_PREFIX "")
  set(test_PREFIX ${test_DEVEL_PREFIX})
else()
  set(test_SOURCE_PREFIX "")
  set(test_DEVEL_PREFIX "")
  set(test_INSTALL_PREFIX /home/cwkj/workspace/track_vehicle4.0/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cwkj/workspace/track_vehicle4.0/src/test/${idir}'.  ${_report}")
    endif()
